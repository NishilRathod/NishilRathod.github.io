...
/**
 * Single-colour 24x24 glyphs that inherit `currentColor`.
 *
 * GitHub and LeetCode marks come from simple-icons (CC0-1.0). The LinkedIn
 * mark is not in that set — it was pulled at LinkedIn's request — so the
 * standard "in" path is used here to link to Nishil's own profile.
 */
